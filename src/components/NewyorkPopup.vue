        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel
              ...
              style="background-image: url('https://assets.origin.drflora.kim/video/newyork_small.png')"
            >
              <div class="text-white flex flex-col justify-center items-center gap-10 lg:flex-row w-full">
                <div
                ...
                <div class="text-center lg:text-right text-white flex-1 flex justify-center items-center lg:items-end">
                  <div>
                    ...
                    <p class="text-white mt-6">
                      It’s not every day you are featured in Times Square! <br />We couldn’t pass up this unique
                      opportunity to shine bright like the city lights in this legendary location.
                    </p>
                    <p class="text-white text-sm">
                      Looking to book an appointment? Whether it is virtual or in-person, a consultation is the first
                      step toward healthier skin. Click on the button below to get started!
                    </p>
                    <a href="/pages/contact" class="c-button c-button--black c-button--black-xs mt-6"
